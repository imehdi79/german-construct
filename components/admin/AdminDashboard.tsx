    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6">
          {section === "dashboard" && <Dashboard content={content} onGo={setSection} dirty={dirty} />}

          {section === "brand" && <BrandSeoEditor site={site} onChange={editSite} />}

          {section === "navfooter" && <NavFooterEditor site={site} onChange={editSite} />}

          {section === "homesections" && <HomeSectionsEditor site={site} onChange={editSite} />}

          {section === "pagetexts" && <PageTextsEditor site={site} onChange={editSite} />}
            ...
            <div className="max-w-3xl space-y-6">
              <Group title="Hero-Bereich (Startseite)">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  ...
                  <Field
                    label="Titel (Akzent)"
                    value={site.hero.titleAccent}
                    onChange={(v) =>
                      update((d) => {
                        d.site.hero.titleAccent = v;
                        return d;
                      })
                    }
                  />
              ...
              <Group title="Kurzbeschreibung">
                <TextArea
                  label="Beschreibung (Footer / SEO)"
                  value={site.descriptionShort}
                  onChange={(v) =>
                    update((d) => {
                      d.site.descriptionShort = v;
                      return d;
                    })
                  }
                />
              ...
              <Group title="Kontaktdaten">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  <Field
                    label="Straße"
                    value={site.contact.address.street}
                    onChange={(v) =>
                      update((d) => {
                        d.site.contact.address.street = v;
                        return d;
                      })
                    }
                  />
                  <Field
                    label="PLZ"
                    value={site.contact.address.zip}
                    onChange={(v) =>
                      update((d) => {
                        d.site.contact.address.zip = v;
                        return d;
                      })
                    }
                  />
                  ...
                  <Field
                    label="Region"
                    value={site.contact.address.region}
                    onChange={(v) =>
                      update((d) => {
                        d.site.contact.address.region = v;
                        return d;
                      })
                    }
                  />
              ...
              <Group title="Öffnungszeiten">
                <Field
                  label="Wochentags"
                  value={site.openingHours.weekdays}
                  onChange={(v) =>
                    update((d) => {
                      d.site.openingHours.weekdays = v;
                      return d;
                    })
                  }
                />
                <Field
                  label="Samstag"
                  value={site.openingHours.saturday}
                  onChange={(v) =>
                    update((d) => {
                      d.site.openingHours.saturday = v;
                      return d;
                    })
                  }
                />
                <Field
                  label="Sonntag"
                  value={site.openingHours.sunday}
                  onChange={(v) =>
                    update((d) => {
                      d.site.openingHours.sunday = v;
                      return d;
                    })
                  }
                />
              ...
              <Group title="Kennzahlen (Startseite)">
                {site.stats.map((stat, i) => (
                  <div
                    key={i}
                    className="grid grid-cols-2 sm:grid-cols-4 gap-3 pb-3 border-b border-gray-100 last:border-0"
                  >
                    <Field
                      label="Wert"
                      type="number"
                      ...
                      onChange={(v) =>
                        update((d) => {
                          d.site.stats[i].value = Number(v) || 0;
                          return d;
                        })
                      }
                    />
          ...
          {section === "services" && (
            <div className="max-w-3xl space-y-4">
              {services.map((svc, i) => (
                ...
                >
                  ...
                  <TextArea
                    ...
                    onChange={(v) =>
                      update((d) => {
                        d.services[i].shortDescription = v;
                        return d;
                      })
                    }
                  />
              ...
              <AddButton
                ...
                onClick={() =>
                  update((d) => {
                    d.services.push(newService(d.services.length));
                    return d;
                  })
                }
              />
              ...
              {gallery.map((item, i) => (
                ...
                >
                  ...
                  <Field
                    ...
                    onChange={(v) =>
                      update((d) => {
                        d.gallery[i].category = v as GalleryItem["category"];
                        return d;
                      })
                    }
                  />
...
function Dashboard({ content, onGo, dirty }: { content: FullContent; onGo: (s: SectionId) => void; dirty: boolean }) {
  const cards = [
    ...
    {
      id: "forms" as const,
      label: "Projektplaner-Formulare",
      count: Object.keys(content.formSchemas).length,
      icon: ClipboardList,
    },
  ];
  return (
