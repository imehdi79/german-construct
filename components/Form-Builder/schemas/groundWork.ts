...
export const bodenarbeitenSchema: Step[] = [
  {
    id: generateId(),
    title: "Um welchen Bodenbelag handelt es sich?",
    fields: [
      {
        id: "Um welchen Bodenbelag handelt es sich?",
        label: "",
        type: "radio",
        required: true,
        options: [
  ...
  {
    id: generateId(),
    title: "Muss alter Boden entfernt werden?",
    fields: [
      {
        id: "Muss alter Boden entfernt werden?",
        label: "",
        type: "radio",
        required: true,
        options: [
  ...
  {
    id: generateId(),
    title: "Ist der Untergrund eben oder uneben?",
    fields: [
      {
        id: "Ist der Untergrund eben oder uneben?",
        label: "",
        type: "radio",
        required: true,
        options: [
          { label: "Eben", value: "Eben" },
          { label: "Uneben", value: "Uneben" },
  ...
  {
    id: generateId(),
    title: "Wie groß ist die zu bearbeitende Fläche?",
    fields: [
      {
        id: "Wie groß ist die zu bearbeitende Fläche?",
        label: "",
        type: "radio",
        required: true,
        options: [
