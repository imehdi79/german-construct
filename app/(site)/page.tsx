...
import { getSiteContent, getServices, getGallery, getFormSchemas, getPlannerCards } from "@/lib/content";
...
export default async function HomePage() {
  const [site, services, gallery, formSchemas, plannerCards] = await Promise.all([
    getSiteContent(),
    getServices(),
    getGallery(),
    getFormSchemas(),
  ...
  return (
    <>
      ...
      <ProjektplanerSection schemas={formSchemas} cards={plannerCards} copy={sections.projektplaner} />
      ...
      <GalerieSection items={gallery} categories={sections.galleryCategories} copy={sections.galerieIntro} />
      {/* <TestimonialsSection items={testimonials} copy={sections.testimonials} /> */}
      <KontaktCtaSection copy={sections.kontaktCta} contact={contact} openingHours={site.openingHours} />
    </>
  );
}
