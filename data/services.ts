...
export const services: Service[] = [
  ...
  },
  {
    ...
    shortDescription: 'Tragfähige und ebenflächige Estriche als solide Basis für jeden Bodenbelag.',
    description:
      'Ein qualitativ hochwertiger Estrich ist die Grundlage für jeden dauerhaften Bodenbelag. Wir führen Zement-, Anhydrit- und Fließestriche fachgerecht aus und sorgen für eine exakt ebene Oberfläche. Dabei berücksichtigen wir bauphysikalische Anforderungen wie Feuchtigkeitsschutz, Wärmedämmung und Schallschutz.',
    icon: 'layers',
    features: [
      'Zement- & Anhydritestrich',
      'Calciumsulfat-Fließestrich',
      'Heizestrich für Fußbodenheizung',
      'Verbund- & Trennschicht-Estrich',
      'Gefälleestrich für Duschen',
      'Schnell-Trocknender Estrich',
    ],
    href: '/leistungen#estricharbeiten',
  },
  {
    id: 'verfugungen',
    title: 'Verfugungen',
  ...
  },
  {
    ...
    description:
      'Terrassen und Außenbereiche brauchen frostsichere, rutschhemmende Materialien, die auch hohen Belastungen standhalten. Wir verlegen Feinsteinzeug, Natursteinplatten und Terrassendielen fachgerecht auf entsprechendem Untergrund und sorgen für eine ordnungsgemäße Entwässerung durch präzise Gefälleplanung.',
    icon: 'sun',
    features: [
