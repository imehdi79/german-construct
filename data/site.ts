...
export const siteContent: SiteContent = {
  brand: {
    ...
    description:
      "Fliesen - Naturstein Aman – Ihr Fachbetrieb für hochwertige Fliesen-, Platten- und Natursteinarbeiten in Neu-Ulm, Ulm und Umgebung. Präzision, Qualität und persönliche Betreuung mit transparenter Abrechnung nach Aufwand oder zum Festpreis.",
  },
  descriptionShort:
    "Ihr kompetenter Partner für Fliesen-, Platten- und Natursteinarbeiten in Neu-Ulm, Ulm und Umgebung. Präzision, Qualität und persönliche Betreuung – vom ersten Gespräch bis zur letzten Fuge.",
  contact: {
    phone: "-",
    mobile: "+49 17634569351",
  ...
  hero: {
    ...
    subtitle:
      "Ihr Fachbetrieb für Fliesen-, Platten- und Natursteinarbeiten in Neu-Ulm, Ulm und Umgebung. Frische Ideen, erstklassige Qualität, transparente Preise.",
  ...
  sections: {
    warumAman: {
      ...
      subtitle:
        "Ihre Vorstellungen perfekt umgesetzt: Mit solidem Fachwissen und zeitgemäßen Techniken entstehen Ergebnisse, die dauerhaft begeistern.",
      imageAlt: "AMAN Handwerker bei der Arbeit – Präzision und Qualität",
      image: "/about-craftsman.jpg",
      reasons: [
        {
          icon: "clock",
          title: "Fachgerechte Ausführung aus einer Hand",
          description:
            "Jedes Projekt wird mit langjähriger Berufserfahrung geplant, persönlich von mir begleitet und präzise ausgeführt – fundiertes Können und Leidenschaft statt anonymer Massenabwicklung.",
        },
        {
          icon: "shield",
          title: "Unser Qualitätsversprechen",
          description:
            "Wir stehen hinter unserer Arbeit. Unsere Leistungen sind solide abgesichert und werden ausschließlich mit hochwertigen, professionellen Materialien ausgeführt.",
        },
        {
          icon: "thumbs-up",
          title: "Faire und transparente Preise",
          description:
            "Ob ein verbindlicher Festpreis nach genauer Besichtigung oder die ehrliche Abrechnung nach tatsächlichem Aufwand: Sie erhalten von uns maximale Flexibilität und volle Kostenkontrolle von Anfang an – ganz ohne versteckte Kosten.",
        },
        {
          icon: "badge-check",
          title: "Eingetragener Fachbetrieb",
          description:
            "Als offizielles Mitglied der Handwerkskammer Schwaben arbeiten wir nach den anerkannten Regeln der Technik und höchsten Qualitätsstandards. Für uns ist echtes Handwerk Verpflichtung",
        },
      ],
    },
    leistungenIntro: {
      ...
      subtitle:
        "Jedes Projekt ist einzigartig – deshalb setzen wir Ihre Wünsche mit Fachverstand, moderner Ausrüstung und absoluter Sauberkeit um. Von der sorgfältigen Planung der Verlegemuster bis zum sauberen Abschluss sorgen wir dafür, dass Ihre neuen Wand- und Bodenbeläge optisch und qualitativ restlos überzeugen.",
  ...
  footer: {
    description:
      "Ihr Fachbetrieb für Fliesen-, Platten- und Natursteinarbeiten in Neu-Ulm, Ulm und Umgebung. Frisch gegründeter Handwerksbetrieb mit Qualität und Handwerkskunst zu fairen Festpreisen.",
  ...
  pages: {
    ...
    kontakt: {
      ...
      betreffOptions: [
        {
          value: "fliesenarbeiten",
          label: "Fliesenarbeiten",
        },
        {
          value: "natursteinarbeiten",
          label: "Natursteinarbeiten",
        },
        {
          value: "verfugungen",
        ...
        },
        {
          ...
          label: "Kostenvoranschlag anfragen",
        },
        {
          value: "sonstiges",
          label: "Sonstiges",
      ...
      requiredNote: {
        prefix:
          "Mit * gekennzeichnete Felder sind Pflichtfelder. Ihre Daten werden gemäß unserer ",
        linkText: "Datenschutzerklärung",
        suffix: " verarbeitet.",
      },
      contactLabels: {
    ...
    stellenangebote: {
      ...
      subtitle:
        "Wir suchen einen erfahrenen Fliesenleger zur Verstärkung unseres wachsenden Teams. Sie arbeiten selbstständig auf unseren Baustellen in Neu-Ulm, Ulm und Umgebung und vertreten dabei die hohen Qualitätsstandards von Fliesen - Naturstein Aman.",
      applyLabel: "Bewerben",
    ...
    projektplaner: {
      ...
      subtitle:
        "Wählen Sie Ihr Projektvorhaben und erhalten Sie schnellstmöglich ein unverbindliches Angebot von uns.",
      infoStrip: [],
    },
  },
  seo: {
    keywords: [
      ...
      "Fliesenleger Fachbetrieb Bayern",
      "Fliesenleger Fachbetrieb Baden-Württemberg",
    ],
    perPage: {
      home: {
        title: "",
        description:
          "Fliesen - Naturstein Aman – Ihr Fachbetrieb für hochwertige Fliesen-, Platten- und Natursteinarbeiten in Neu-Ulm, Ulm und Umgebung. Präzision, Qualität und persönliche Betreuung nach flexibler Absprache: als Festpreis oder fair nach Aufwand.",
      },
      projektplaner: {
        title: "Projektplaner",
        description:
          "Planen Sie Ihr Fliesen- oder Natursteinprojekt online und erhalten Sie in kürzester Zeit ein kostenloses, unverbindliches Angebot.",
      },
      leistungen: {
        title: "Leistungen",
        description:
          "Unsere Leistungen: Fliesenarbeiten, Natursteinarbeiten, Verfugung & Silikonarbeiten sowie Fliesensanierung in Neu-Ulm, Ulm und Umgebung.",
      },
      galerie: {
        title: "Galerie",
        description:
          "Projektgalerie von Fliesen-Naturstein Aman – abgeschlossene Fliesen- und Natursteinprojekte in Neu-Ulm, Ulm und Umgebung.",
      },
      kontakt: {
        title: "Kontakt",
        description:
          "Kontaktieren Sie Fliesen - Naturstein Aman in Neu-Ulm, Ulm und Umgebung – kostenlose Beratung und unverbindliche Angebote für Ihr Fliesen- oder Natursteinprojekt.",
      },
      stellenangebote: {
        title: "Stellenangebote",
        description:
          "Karriere bei Fliesen-Naturstein Aman – aktuelle Stellenangebote für Fliesenleger und Auszubildende in Neu-Ulm, Ulm und Umgebung.",
      },
    },
  },
};
